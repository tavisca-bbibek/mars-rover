...
public class MarsRoboRover {
    ...
    public static void main(String[] args) {
        ...
        Vector currentVector = new Vector(x, y, direction);

        Command[] commands = extractCommands(commandString);

        RoboRover roboRover = new RoboRover(currentVector);
        Vector newVector = roboRover.rove(commands);
        ...
        System.out.println("New Implementation: " + newVector.x + " " + newVector.y
                + " " + toDirectionChar(newVector.direction));
